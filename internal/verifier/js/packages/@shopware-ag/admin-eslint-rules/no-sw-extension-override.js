...
export default {
    meta: {
        type: "problem",
        docs: {
            description: "Disallow overwriting sw-extension-* components using Shopware.Component.override",
        ...
        return {
            ...
            CallExpression(node) {
                ...
                if (isShopwareComponentOverride || isAliasOverride) {
                    ...
                    if (firstArg && firstArg.type === "Literal" && typeof firstArg.value === "string" && firstArg.value.startsWith("sw-extension-")) {
                        context.report({
                            node,
